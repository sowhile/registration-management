    ...
    <el-table
      ...
      <el-table-column align="center" label="操作" width="250">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="success" @click="approval(scope.row.id, 2)">通过</el-button>
          <el-button size="mini" type="danger" @click="approval(scope.row.id, -1)">不通过</el-button>
        </template>
      </el-table-column>
